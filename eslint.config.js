...
export default tseslint.config(
  ...
  // Design-handoff bundles dropped into a change folder (exported HTML/JS mockups)
  // are reference artifacts, not source — never lint them either.
  { ignores: [".claude/**", "context/**/handoff/**"] },
